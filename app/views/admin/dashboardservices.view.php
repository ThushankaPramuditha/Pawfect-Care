...
<head>
    ...
    <?php $activePage = 'dashboardservices'; ?>
            ...
            <div class="analyse" style="margin-top:50px;">
                <div class="sales">
                    <div class="status">
                        <div class="info">
                            <p
                                style="font-size:20px; display:flex; justify-content:center; text-align:center; font-weight:bolder;">
                                Vet<br> Appointments</p>
                            <p style="font-size:20px; text-align:center; font-weight:bolder;">
                                <?php echo $appointmentbookings; ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="sales">
                    <div class="status">
                        <div class="info">
                            <p
                                style="font-size:20px; display:flex; justify-content:center; font-weight:bolder;text-align:center;">
                                Daycare<br> Bookings</p>
                            <p style="font-size:20px; text-align:center; font-weight:bolder;">
                                <?php echo $todaydaycarebookings; ?></p>
                ...
                <div class="sales">
                    <div class="status">
                        <div class="info">
                            <p
                                style="font-size:20px; display:flex; justify-content:center; font-weight:bolder;text-align:center;">
                                Ambulance Bookings</p>
                            <p style="font-size:20px; text-align:center; font-weight:bolder;">
                                <?php echo $ambulancebookings; ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="margin-top:100px; display:flex; flex-direction:row;">
                <div>
                    ...
                    var data = {
                        ...
                        datasets: [{
                            ...
                            data: [<?php echo $weeekdaycarebookings; ?>, <?php echo $weekappointments; ?>,
                                <?php echo  $weekambulancebookings; ?>
                            ],
                ...
                <div style="margin-left:50px;">
                    ...
                    var data = {
                        ...
                        datasets: [{
                            label: 'Appointments Income',
                            data: [<?= $week1Income ?>, <?= $week2Income ?>, <?= $week3Income ?>,
                                <?= $week4Income ?>
                            ],
                            backgroundColor: [
