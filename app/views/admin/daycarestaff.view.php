...
<body>
    ...
    <div style="margin-top: 80px; ">
        ...
        <div style="margin-left: 230px; margin-top:130px">
            <div class="panel-header">
                ...
                <div class="search-bar">
                    <input type="text" id="search" placeholder="Search daycare staff...">
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                        <tr>
                            <td colspan="10">No daycare staff found.</td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
        ...
        <script>
            // to filter the table when searching for a staff
        $(document).ready(function() {
            $('#search').on('keyup', function() {
                var searchTerm = $(this).val();
                $.ajax({
                    url: "<?php echo ROOT ?>/Admin/DaycareStaff/search",
                    type: "POST",
                    data: {
                        search: searchTerm
                    },
        ...
        function openActivateModal(id) {
            ...
            `<?php echo ROOT?>/admin/DaycareStaff/activate/${id}`; //hereeee
            span.onclick = function() {
                modal.style.display = "none";
            }
        ...
        function openDeactivateModal(id) {
            ...
            `<?php echo ROOT?>/admin/DaycareStaff/deactivate/${id}`; //hereeee
            span.onclick = function() {
                modal.style.display = "none";
            }
