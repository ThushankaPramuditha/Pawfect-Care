...
<head>
    ...
    * {
    ...
    main .recent-orders table main table tbody td {
        height: 2.8rem;
...
<body>
    ...
    ?>
                        <div
                            style="display:flex; flex-direction:column; overflow:hidden; height:310px; overflow-y:scroll;">
                            <?php foreach ($daycarebookinguser as $daycarebookingnotification) { ?>
                            <div class="notification"
                                style="display:flex; flex-direction:column; background-color:#CBC3E3">
                                <!-- <div class="icon">
                <span class="material-icons-sharp">
                    volume_up
                </span>
                                ...
                                <div class="notification-item">
                                    <div class="info">
                                        ...
                                        <p>
                                            <?php echo $daycarebookingnotification['id']; ?> has been booked for daycare
                                            on <?php echo $daycarebookingnotification['drop_off_date'];?> at
                                            <?php echo $daycarebookingnotification['drop_off_time'] ;?> to
                                            <?php echo $daycarebookingnotification['pick_up_time'] ;?>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div
                            style="height:50px; display:flex; justify-content:center; align-items:center; background-color:rgb(153, 102, 255); cursor:pointer; color:white; font-weight:bolder; font-size:20px; margin-top:10px; border-radius:10px;">
