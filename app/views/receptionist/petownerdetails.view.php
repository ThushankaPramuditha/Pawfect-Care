        ...
        <div class="modal-form" id="add-modal">
            <div class="modal-content">
                ...
                <div class="form-container">
                    <form id="add-petowner-form" action="<?php echo ROOT?>/receptionist/petownerdetails/add"
                        method="post">
                        <div class="column">
                            ...
                            <div class="flex-container">
                                <button class="button" type="submit" name="signup" id="add-petowner-button">Sign
                                    up</button>
                            </div>
