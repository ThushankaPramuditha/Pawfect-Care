...
<body>
    ...
    <div style="margin-top: 80px; ">
        ...
        <div style="margin-left: 230px; margin-top:130px">
            <div class="panel-header">
                ...
                <div class="search-bar">
                    <input type="text" id="search" placeholder="Search medical staff...">
            ...
            <div class="table-container">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                        <tr>
                            <td colspan="10">No medical staff found.</td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
        ...
        <div class="modal-form" id="add-modal">
            <div class="modal-content">
                ...
                <div class="form-container">
                    <form id="add-staff-form" action="<?php echo ROOT?>/Admin/MedicalStaff/add" method="post">
                        <div class="column">
                        ...
                        <div class="column">
                            ...
                            <textarea id="qualifications" name="qualifications" style="border-radius: 10px;"
                                rows="4"></textarea>
                        ...
                        <div class="flex-container">
                            <button type="submit" id="add-staff-button">Add Medical Staff</button>
                        </div>
        ...
        <!-- Update Medical Staff Modal -->
        <div class="modal-form" id="update-modal">
            <div class="modal-content">
                <span class="close">&times;</span>
                <h1>Update Medical Staff</h1>
                <div id="updatemedicalstaff" class="form-container">
        ...
        <!-- check this -->
        <!-- Deactivate Medical Staff Modal -->
        ...
        $(document).ready(function() {
            $('#search').on('keyup', function() {
                ...
                $.ajax({
                    url: "<?php echo ROOT ?>/Admin/MedicalStaff/search",
                    type: "POST",
                    data: {
                        search: searchTerm
                    },
        ...
        function openUpdateModal(id) {
            ...
            $.get(`<?php echo ROOT?>/admin/MedicalStaff/viewMedicalStaff/${id}`, function(data) {
                // Update the modal content with the fetched data
                $("#updatemedicalstaff").html(data);
            });
        ...
        function openActivateModal(id) {
            ...
            document.getElementById("activate-staff").href =
            `<?php echo ROOT?>/admin/MedicalStaff/activate/${id}`; //hereeee
            span.onclick = function() {
                modal.style.display = "none";
            }
        ...
        function openDeactivateModal(id) {
            ...
            `<?php echo ROOT?>/admin/MedicalStaff/deactivate/${id}`; //hereeee
            span.onclick = function() {
                modal.style.display = "none";
            }
