...
<head>
    ...
    <script src="<?php echo ROOT?>/assets/js/daycarebookingvalidation.js"></script>
    ...
    .form-container .column {
        width: 48%;
        /* Adjusted to accommodate space between columns */
    }
...
<body>
    ...
    <div class="modal-content" style="margin-top:10px;">
        ...
        <div class="form-container">
            <form id="daycarebooking-form" action="<?php echo ROOT?>/petowner/daycarebookinguser/addDaycarebooking"
                method="post">
                <div style="display: flex; justify-content: space-between; margin-top:10px;">
                    <div class="column" style="margin-left:30px; margin-right:30px;">
                        ...
                        <input type="hidden" id="petowner_id" name="petowner_id"
                        ...
                        <input type="date" id="drop-off-date" name="drop-off-date" min="<?php echo date('Y-m-d');?>">
                    ...
                    <div class="column" style=" margin-left:20px; padding-right:50px;">
                        ...
                        <textarea id="list-of-items" name="list-of-items"
                            style="border-radius: 10px; margin-right:60px;" rows="1"></textarea>
                        ...
                        <textarea id="pet-behaviour" name="pet-behaviour" style="border-radius: 10px;"
                            rows="1"></textarea>
    ...
    <script>
    document.getElementById("list-of-items").addEventListener("input",  validateListOfItems);
    document.getElementById("allergies").addEventListener("focus", validateListOfItems);
    document.getElementById("pet-behaviour").addEventListener("focus", validateAllergies);
    document.getElementById("medications").addEventListener("focus", validatePetBehaviour);
    document.getElementById("medications").addEventListener("input", validateMedications);


    function validateAddForm() {
        var isValid = true;
        isValid = validateDropOffDate() && isValid;
            isValid = validateDropOffTime() && isValid;
            isValid = validatePickUpTime() && isValid;
            isValid = validateListOfItems() && isValid;
            isValid = validateAllergies() && isValid;
            isValid = validatePetBehaviour() && isValid;
