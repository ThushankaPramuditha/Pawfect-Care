...
<h1>Edit Profile</h1> 
    <div class = "form-container"> 
            ...
            $qualifications = "DVM, PhD"; // Replace with actual qualifications
            ?>
                ...
                <textarea id="qualifications" name="qualifications" style="border-radius: 10px;" rows="4" required><?php echo $qualifications; ?></textarea>
