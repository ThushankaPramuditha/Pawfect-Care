...
<body>
    ...
    <h2 style="text-align:center; color:black; padding-top:20px; font-size:60px; font-weight:bold; font-family:'Poppins', sans-serif">Medical History</h2>
    <div class="container">
    ...
    <div class="search-bar">
        <input type="text" id="search" placeholder="Search by treatment or veterinarian name...">
    ...
    <script>
           $(document).ready(function(){
            $('#search').on('keyup', function(){
                ...
                $.ajax({
                    url: "<?php echo ROOT ?>/Petowner/MedicalHistory/search",
                    type: "POST",
                    data: {
                        search: searchTerm, 
                        petId: petId  
