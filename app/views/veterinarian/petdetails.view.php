...
<script>
    ...
    $(document).ready(function(){
            $('#search').on('keyup', function(){
                ...
                $.ajax({
                url: "<?php echo ROOT ?>/veterinarian/petdetails/search",
                type: "POST",
    ...
    function getMedicalHistory(petId) {
        window.location.href = "<?php echo ROOT ?>/veterinarian/medicalhistory/" + petId;
    }


    function getVaccinationHistory(petId) {
        window.location.href = "<?php echo ROOT ?>/veterinarian/vaccinationhistory/" + petId;
    }
