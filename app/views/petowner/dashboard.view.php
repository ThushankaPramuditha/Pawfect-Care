        ...
        <div class="flex-container" style="display:flex; justify-content: space-between; padding:0 40px;">
            ...
            <div>
                <button class="user-profile-button"
                    onclick="location.href='<?php echo ROOT ?>/petowner/userprofile'">Profile Settings</button>
            </div>
        ...
        <div class="container" style="display:flex; flex-direction:row; padding: 0 40px;">
            ...
            <div class="new-users" style="display:flex; width:70%;  margin-right: 10px;">
                <div class="user-list" style="display:flex; flex-wrap: wrap; gap:1rem; ">
                 ...
                 foreach ($pets as $pet): ?>
                    <div class="pet" style="display:flex; flex-direction:column; margin-top:10px; margin-bottom:1px;"
                        id="pet_<?php echo $pet->id; ?>">
                        ...
                        <div style="display:flex; flex-direction:row;">
                            <div style="margin-top:15px;">
                                ...
                                <?php else: ?>
                                <img src="<?= ROOT ?>/assets/images/defaultpet.jpeg" alt="Profile Picture"?>
                                    <?php endif; ?> 
                                </div>
                            ...
                            <div
                                style="display:flex; flex-direction:row; justify-content:space-between; margin-left:10px;">
                                <button
                                    onclick="location.href='<?php echo ROOT ?>/petowner/medicalhistory/getMedicalData/<?php echo $pet->id; ?>'">Medical
                                    History</button>
                                <button
                                    onclick="location.href='<?php echo ROOT ?>/petowner/vaccinationhistory/getVaccinationData/<?php echo $pet->id; ?>'">Vaccination
                                    History</button>
                                <button
                                    onclick="location.href='<?php echo ROOT ?>/petowner/appointmenthistory/getAppointmentData/<?php echo $pet->id; ?>'">Appointment
                                    History</button>
                ...
                <div class="announcement"
                    style="display: flex; flex-direction: column; align-items: flex-end; flex-wrap: wrap; margin-left: 20px; ">
                    <?php 
            ?>
                    <p style="font-size:20px; font-weight:bolder;">Vet Appointments</p>
                    <div
                        style="display:flex; flex-direction:column; overflow:hidden; height:120px; overflow-y:scroll; margin-left:40px;">
                        ...
                        <div class="notification"
                            ...
                            <div class="notification-item" style="min-height:50px;">
                                ...
                                <span id="cancel-notification" class="material-icons-sharp"
                                    style="cursor:pointer; color:#6a3879; margin-left:300px; font-size:11px;"
                                    onclick="cancelNotification(<?php echo $vnotification->id ?>)">close</span>
                                <div class="info">
                                    <!-- <small class="text-muted" style="font-size:14px;">Appointment</small> -->
                                    <p><?php echo $vnotification->message ?></p>
                                    <button style="font-size:0.8rem; padding:0.5rem; margin:0; "
                                        onclick="location.href='<?=ROOT?>/petowner/appointments/cancel/<?php echo $vnotification->appointment_id?>/<?php echo $vnotification->id?>'">Cancel
                                        Appointment</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="display:flex; flex-direction:column; overflow:hidden; height:120px; overflow-y:scroll;">
                        ...
                        <div class="notification"
                            ...
                            <div class="notification-item" style="height:80px;">
                                ...
                                <span id="cancel-notification" class="material-icons-sharp"
                                    style="cursor:pointer; color:#6a3879; margin-left:300px; font-size:12px;"
                                    onclick="cancelNotification(<?php echo $dnotification->id ?>)">close</span>
                                <div class="info">
                    ...
                    <div style="display:flex; flex-direction:column; overflow:hidden; height:120px; overflow-y:scroll;">
                        ...
                        <div class="notification"
                            ...
                            <div class="notification-item" style="height:80px;">
                                ...
                                <span id="cancel-notification" class="material-icons-sharp"
                                    style="cursor:pointer; color:#6a3879; margin-left:300px; font-size:12px;"
                                    onclick="cancelNotification(<?php echo $tnotification->id ?>)">close</span>
                                <div class="info">
                                    <!-- <small class="text-muted" style="font-size:14px;">Daycare booking</small> -->
                                    <p>
