<form id="updated-form" action="<?php echo ROOT ?>/Veterinarian/MedicalHistory/update/<?php echo $medicalhistory->id; ?>" method="post">
        <div class="column">

        <label for="update-date time">Date Time:</label>
        <input type="datetime-local" class="disabled-field" id="update-date_time" name="date_time" value="<?php echo $medicalhistory->date_time;?>">
