            ...
            <div class="card-container">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="<?php echo ROOT?>/assets/images/ambulance.png" alt="Ambulance">
                    </div>
                    <div class="card-text">
                        <h3 class="card-title"><?= htmlspecialchars($drivers->name) ?></h3>
                        <p class="card-description"><?= htmlspecialchars($drivers->contact) ?></p>
                        <p class="card-description"
                            style="color: <?= $drivers->availability == 'available' ? '#00c749' : '#ff0000'; ?>;">
                            <?= htmlspecialchars($drivers->availability) ?>
                        </p>

                    </div>
                    <div class="button-container">
                        <button type="button" class="btn"
                            onclick="window.location.href='<?=ROOT?>/receptionist/ambulancedrivers/changeAvailability/<?= htmlspecialchars($drivers->id); ?>'">
                            <?= $drivers->availability == 'available' ? "Mark as Unavailable" : "Mark as Available"; ?>
                        </button>
