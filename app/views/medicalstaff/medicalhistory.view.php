        ...
        <div class="form-container">
            <form id="add-treatment-form" action="<?php echo ROOT?>/Medicalstaff/MedicalHistory/add" method="post">
                ...
                <div class="column">
                    ...
                    <textarea id="prescription" name="prescription" rows="4" style="border-radius: 10px;"></textarea><br>
...
document.getElementById('remarks').addEventListener('focus', validatePrescription);
