...
<body>
    ...
    <div style="margin-top: 80px; ">
        ...
        <div style="margin-left: 230px; padding: 10px 100px 100px 100px;">
            <?php include '../app/views/components/panel-header-bar/hiuser.php'; ?>
            <h1>My Profile</h1>
            <div class="image-info-container">
                <div>
                    ...
                    <div class="pair">
                        <div class="key">Qualifications:</div>
                        <div class="value"><?= htmlspecialchars($data['userdata']->qualifications)?></div>
                    </div>
                </div>
                <div>
                    <?php if($data['userdata']->image):?>
                    <img src="<?= ROOT ?>/uploads/veterinarians/<?= $data['userdata']->image ?>" alt="Profile Picture"
