...
$(document).ready(function() {
    ...
    // to deactivate when filtered by search
    $('body').on('click', '.deactivate-button', function() {
        var id = $(this).closest('tr').attr('key');
        openDeactivateModal(id);
    });

    // to activate when filtered by search
...
function openDeactivateModal(id) {
    ...
    document.getElementById("deactivate-staff").href =
        `<?php echo ROOT?>/admin/AmbulanceDrivers/deactivate/${id}`; //hereeee
    span.onclick = function() {
        modal.style.display = "none";
    }
...
// Attach event listeners for validation for add form
...
function validateAddForm() {
    ...
    // Validate the form fields at the submission
...
// Attach event listeners for validation for update form
...
//sweeetalert for validation SUCCESS and ERROR using the session
