                            ...
                            <div class="select-container" style=" margin-top:10px; margin-bottom: 0px;">
                                ...
                                <select name="vet_id" id="vet-select" required>
                                    ...
                                    <option value="<?= htmlspecialchars($vet->id) ?>">
                                        <?= htmlspecialchars($vet->name) ?></option>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
                                </select>
                    ...
                    if (data) {
                        ...
                        if (data.free <= 0) {
                            Swal.fire({
                                ...
                                document.getElementById('vet-select').value =
                                    'nothing'; // Reset the vet dropdown
    ...
    document.getElementById("add-appointment-form").addEventListener('submit', function(event) {
        ...
        if (vetId == 'nothing') {
            ...
            Swal.fire({
                ...
                document.getElementById('vet-select').value =
                    'nothing'; // Reset the vet dropdown if the alert is dismissed
            });
            return;
        }
