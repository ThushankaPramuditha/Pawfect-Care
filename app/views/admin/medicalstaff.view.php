         ...
         $(document).ready(function(){
           ...
           // Get the modal elements
            ...
            function openActivateModal(id) {
                ...
                document.getElementById("activate-staff").href = `<?php echo ROOT?>/admin/MedicalStaff/activate/${id}`;  //hereeee
                span.onclick = function() {
                modal.style.display = "none";
                }
            ...
            function openDeactivateModal(id) {
                ...
                document.getElementById("deactivate-staff").href = `<?php echo ROOT?>/admin/MedicalStaff/deactivate/${id}`;  //hereeee
                span.onclick = function() {
                modal.style.display = "none";
                }
